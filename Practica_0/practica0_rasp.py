# -*- coding: utf-8 -*-
"""
Created on Tue Aug 26 13:16:29 2025
...
pico_ip = "192.168.0.X"  # Reemplaza con la IP obtenida del Monitor Serial
...
# Botón para encender el LED (verde brillante HTML)
btn_encender = tk.Button(
    root, text="Encender LED",
    command=encender_led,
    bg="#28a745",  # Verde brillante (Bootstrap Green)
    fg="#ffffff",  # Blanco puro
    width=20
)
btn_encender.pack(pady=5)

# Botón para apagar el LED (rojo brillante HTML)
btn_apagar = tk.Button(
    root, text="Apagar LED",
    command=apagar_led,
    bg="#dc3545",  # Rojo brillante (Bootstrap Red)
    fg="#ffffff",  # Blanco puro
    width=20
)
